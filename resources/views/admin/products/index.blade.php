            ...
            <ol class="list-unstyled  ancestor">
                @foreach($warehouses as $warehouse)
                    <li>
                        ...
                        <span class="hidden on-off">
                            <span class="glyphicon glyphicon-edit  warehouses-edit"  alt="{{ $warehouse->id }}" aria-hidden="true"></span>
                            <span class="glyphicon glyphicon-trash warehouse-trash"  alt="{{ $warehouse->id }}" aria-hidden="true"></span>
                        </span>
                        <ol class="hidden" style="list-style-type: none;">
                            @foreach($warehouse->classes as $class)
                                <li  alt="{{ $class->id }}" type_class="classes">
                                    ...
                                    <span class="hidden on-off">
                                        <span class="glyphicon glyphicon-edit  class-edit"  alt="{{ $class->id }}" aria-hidden="true"></span>
                                        <span class="glyphicon glyphicon-trash class-trash"  alt="{{ $class->id }}" aria-hidden="true"></span>
                                    </span>
                                    <ol class="hidden" style="list-style-type: none;">
                                        @foreach($class->categories as $category)
                                            <li alt="{{ $category->id }}" type_class="categories"><a
                                                ...
                                                <span class="hidden on-off">
                                                       <span class="glyphicon glyphicon-edit category-edit"  alt="{{ $category->id }}" aria-hidden="true"></span>
                                                       <span class="glyphicon glyphicon-trash category-trash"  alt="{{ $category->id }}" aria-hidden="true"></span>
                                                </span>

                                            </li>
                                        @endforeach
                                        <li class="hidden on-off add_category" id="add_category" calt="{{ $class->id }}"><a href="jacascript::void(0)">添加三级分类</a>
                            ...
                            @endforeach
                            <li class="hidden on-off add_class" id="add_class" walt="{{ $warehouse->id }}"><a href="jacascript::void(0)">添加二级分类</a>
                                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                            </li>
                        </ol>
                ...
                @endforeach
                <li class="hidden on-off add_warehouse" id="add_warehouse"><a href="jacascript::void(0)">添加仓库</a>
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                </li>
            </ol>
        </div>
